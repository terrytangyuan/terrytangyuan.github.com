...
* [Couler](https://github.com/couler-proj/couler) where I designed the unified interface and contributed to many major components of the system.
...
* I co-authored two books: [*TensorFlow in Practice*](http://terrytangyuan.github.io/2017/02/12/tensorflow-in-practice-book-chinese/) and [*Dive into Deep Learning*](https://d2l.ai/).
